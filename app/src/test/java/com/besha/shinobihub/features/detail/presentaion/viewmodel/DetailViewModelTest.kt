...
import com.besha.shinobihub.features.detail.domain.usecase.*
...
class DetailViewModelTest {
    ...
    @Test
    fun `SwitchTab emits SwitchTab result`() = runTest {
    ...
    @Test
    fun `GetDetailMovie emits loading then success`() = runTest {
        val movieId = 123
    ...
    @Test
    fun `GetMovieVideo emits loading then success`() = runTest {
        val movieId = 123
    ...
    @Test
    fun `GetMovieSimilar emits loading then success`() = runTest {
        val movieId = 123
    ...
    @Test
    fun `GetMovieReviews emits loading then success`() = runTest {
        val movieId = 123
    ...
    @Test
    fun `GetMovieAccountState emits success when session exists`() = runTest {
        val movieId = 123
    ...
    @Test
    fun `ToggleFavorite emits ToggleFavoriteResult with code 1 for added`() = runTest {
    ...
    @Test
    fun `ToggleWatchList emits ToggleWatchlistResult with code 1 for added`() = runTest {
    ...
    @Test
    fun `GetSessionId emits SessionIdLoaded`() = runTest {
    ...
    @Test
    fun `ResetToggleCode emits ToggleCodeResult with 0`() = runTest {
