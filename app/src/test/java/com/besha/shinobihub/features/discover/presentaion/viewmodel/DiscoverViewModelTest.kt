...
class DiscoverViewModelTest {
    ...
    @Test
    fun `GetGenreList emits loading true, success result, then loading false`() =
        runTest {
    ...
    @Test
    fun `GetGenreList emits loading true, error result, then loading false`() =
        runTest {
    ...
    @Test
    fun `GetGenreList emits loading true, empty result, then loading false`() =
        runTest {
    ...
    @Test
    fun `GetDiscoverMovie emits loading true, success result, then loading false`() =
        runTest {
            val genreId = "28"
    ...
    @Test
    fun `GetDiscoverMovie emits loading true, error result, then loading false`() =
        runTest {
            val genreId = "28"
    ...
    @Test
    fun `GetDiscoverMovie emits loading true, empty result, then loading false`() =
        runTest {
            val genreId = "28"
    ...
    @Test
    fun `GetDiscoverTv emits loading true, success result, then loading false`() =
        runTest {
            val genreId = "18"
    ...
    @Test
    fun `GetDiscoverTv emits loading true, error result, then loading false`() =
        runTest {
            val genreId = "18"
            val exception = Throwable("API Error")
